# Release Notes - Catálogo Busca na Rede - Desktop (Versão de testes 0.1.1)
...
### Observação:
  Essa 0.1.1 é uma versão de testes, porém ainda não foram implementados alguns recursos.
...
## Como Atualizar
Para atualizar para a versão 0.1.1 do Catálogo Busca na Rede - Desktop, siga estas etapas:

1. Acesse o [repositório no GitHub](URL) e baixe o pacote da versão 0.1.1.
